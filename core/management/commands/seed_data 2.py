...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        self.create_office_profile()
        clients = self.create_clients()
        opponents = self.create_opponents()
        cases = self.create_cases(clients, opponents)
        self.create_sessions(cases)
        self.create_tasks(cases)
        self.create_appointments(clients)
        self.create_fees_and_payments(cases)
        self.create_invoices(clients)
        self.create_expenses(cases)
        self.create_contracts_and_poa(clients)
    ...
    def create_cases(self, clients, opponents):
        """إنشاء القضايا"""
        cases_data = [
    ...
    def create_sessions(self, cases):
        """إنشاء الجلسات"""
        sessions_data = [
    ...
    def create_appointments(self, clients):
        """إنشاء المواعيد"""
        appointments_data = [
    ...
    def create_fees_and_payments(self, cases):
        """إنشاء الأتعاب والدفعات"""
        fees_data = [
    ...
    def create_invoices(self, clients):
        """إنشاء الفواتير"""
        invoices_data = [
    ...
    def create_expenses(self, cases):
        """إنشاء المصروفات"""
        expenses_data = [
            {'description': 'رسوم محكمة', 'category': 'court_fees', 'amount': 500, 'case': '8555'},
            {'description': 'مواصلات', 'category': 'transport', 'amount': 200, 'case': None},
            {'description': 'طباعة مستندات', 'category': 'documents', 'amount': 150, 'case': '12345'},
            {'description': 'أتعاب خبير', 'category': 'other', 'amount': 3000, 'case': '34567'},
            {'description': 'إيجار المكتب', 'category': 'utilities', 'amount': 2000, 'case': None},
        ]
    ...
    def create_contracts_and_poa(self, clients):
        """إنشاء العقود والتوكيلات"""
        contracts_data = [
        ...
        PowerOfAttorney.objects.get_or_create(
